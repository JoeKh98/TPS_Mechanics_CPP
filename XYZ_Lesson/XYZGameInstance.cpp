...
UXYZGameInstance::UXYZGameInstance()
{
	...
	OnStartSessionCompleteDelegate = FOnCreateSessionCompleteDelegate::CreateUObject(this, &UXYZGameInstance::OnStartOnlineGameComplete);
...
void UXYZGameInstance::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
...
void UXYZGameInstance::FindAMatch(bool bIsLAN)
{
